# Projeto Trybe Tunes [View/Ver](https://j-pster.github.io/TrybeTunes/)
...
1. Clone o repositório
  * `git clone git@github.com:J-Pster/TrybeTunes.git`
...
Nesse projeto eu utilizo o React e o React Router Dom para criar uma especie de Spotfy que toca previews de musicas, fazemos a requisições das musicas através de uma API e salvamos isso nos estados dos componentes, o projeto inteiro envolve bastante desenvoltura para criar as páginas, as props, as validações das props, as callbacks e todos os elementos utilizados no site.
